...
if coords:
    ...
    shot = df_shots.loc[shot_index]
    resultado = shot["resultado"]
    xg = shot["xg"]

    st.subheader(f"Vídeo da finalização: {resultado} (xG: {xg:.2f})")
...
if video_path is not None:
    ...
    st.video(video_bytes, width=1000)  # <- define o tamanho do vídeo
else:
